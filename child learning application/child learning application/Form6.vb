...
Public Class Form6
    ...
    Private Sub btnJ_Click(sender As Object, e As EventArgs) Handles btnJ.Click
        ...
        txtSay.Text = "J is for jack rabbit"
    End Sub
